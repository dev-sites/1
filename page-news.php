    ...
    <div class="container">
      <div class="content row">
        <div class="posts col-sm-8">
          <section>
            <h1>/ <a href="/">Главная</a> / <span class="active"><?php wp_title(''); ?></span> /</h1>
            <?php
            ...
            <?php
              ...
              echo paginate_links( array(
                ...
                'prev_text' => '<span aria-hidden="true">&larr;</span> К новым записям',
                'next_text' => 'К старым записям <span aria-hidden="true">&rarr;</span>',
                'type' => 'list'
              ) );
